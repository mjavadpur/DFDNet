...
if __name__ == '__main__':
    ...
    file_ids = {
        ...
        'DFD':{
            #'latest_net_G.pth':
            #'1UCo7YEbLLa1_87b0AoWmzhTGyrw-26nb', 
            #'vgg19.pth':
            #'1SfKKZJduOGhDD27Xl01yDx0-YSEkL2Aa'
            'left_eye_32_center.npy':
            '1sEB9j3s7Wj9aqPai1NF-MR7B-c0zfTin',
            'left_eye_64_center.npy':
            '1H4kByBiVmZuS9TbrWUR5uSNY770Goid6',
            'left_eye_128_center.npy':
            '10ctK3d9znZ9nGN3d1Z77xW3GGshbeKBb',
            'left_eye_256_center.npy':
            '1gcwmrIZjPFVu-cHjdQD6P4luohkPsil-',
            'mouth_32_center.npy':
            '1rJ8cORPxbJsIVAiNrjBag0ihaY_Mvurn',
            'mouth_64_center.npy':
            '1LkfJv2a3ud-mefAc1eZMJuINuNdSYgYO',
            'mouth_128_center.npy':
            '1LH-nxD__icSJvTiAbXAXDch03oDtbpkZ',
            'mouth_256_center.npy':
            '1JRTStLFsQ8dwaQjQ8qG5fNyrOvo6Tcvd',
            'nose_32_center.npy':
            '1Z4AkU1pOYTYpdbfljCgNMmPilhdEd0Kl',
            'nose_64_center.npy':
            '1Z4e1ltB3ACbYKzkoMBuVtzZ7a310G4xc',
            'nose_128_center.npy':
            '1fqWmi6-8ZQzUtZTp9UH4hyom7n4nl8aZ',
            'nose_256_center.npy':
            '1wfHtsExLvSgfH_EWtCPjTF5xsw3YyvjC',
            'right_eye_32_center.npy':
            '1Jr3Luf6tmcdKANcSLzvt0sjXr0QUIQ2g',
            'right_eye_64_center.npy':
            '1sPd4_IMYgqGLol0gqhHjBedKKxFAxswR',
            'right_eye_128_center.npy':
            '1eVFjXJRnBH4mx7ZbAmZRwVXZNUbgCQec',
            'right_eye_256_center.npy':
            '1w0GfO_KY775ZVF3KMk74ya6QL_bNU4cJ'
